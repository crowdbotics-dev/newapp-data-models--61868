...
function modules_articles_article_list(payload) {
  return newappdatamodelsAPI.get(`/modules/articles/article/`);
}

function modules_articles_article_create(payload) {
  return newappdatamodelsAPI.post(`/modules/articles/article/`, payload.data);
}
...
function modules_articles_article_retrieve(payload) {
  return newappdatamodelsAPI.get(`/modules/articles/article/${payload.id}/`);
}

function modules_articles_article_update(payload) {
  return newappdatamodelsAPI.put(`/modules/articles/article/${payload.id}/`, payload.data);
}

function modules_articles_article_partial_update(payload) {
  return newappdatamodelsAPI.patch(`/modules/articles/article/${payload.id}/`, payload.data);
}

function modules_articles_article_destroy(payload) {
  return newappdatamodelsAPI.delete(`/modules/articles/article/${payload.id}/`);
}
